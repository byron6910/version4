            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <td> <?php echo e($origen->fecha); ?></td>
                        <td> <?php echo e($origen->hora); ?></td>
                       
                        <td> <?php echo e($origen->stock); ?></td>
                        <td> <?php echo e($origen->condicion); ?></td>
                        <td> <?php echo e($origen->cooperativa->nombre); ?></td>
                        <td> <?php echo e($origen->cooperativa->telefono); ?></td>
                        <td> <?php echo e($origen->cooperativa->correo); ?></td>
