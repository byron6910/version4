...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('LTE/css/bootstrap-select.min.css')); ?>">
  ...
  <body class="hold-transition skin-red sidebar-mini">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <li><a href="<?php echo e(url('/ingreso')); ?>"><i class="fa fa-circle-o"></i> Ingreso</a></li>
              <li><a href="<?php echo e(url('/detalle')); ?>"><i class="fa fa-circle-o"></i> Detalle Reserva</a></li>
    ...
    <script src="<?php echo e(asset('LTE/js/bootstrap-select.min.js')); ?>"></script>
