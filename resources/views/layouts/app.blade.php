                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @guest
                            ...
                            <li><a href="{{ route('user-new') }}">Registrar </a></li>
                        @else
                            <li class="dropdown">
                                ...
                                <img src="/imagenes/usuarios/fotos/{{ Auth::user()->foto }}" style="width:32px; height:32px; position:absolute; top:10px; left:10px; border-radius:50%">
