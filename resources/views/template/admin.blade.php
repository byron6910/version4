...
<html>
  <head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('LTE/css/font-awesome.css')}}">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{asset('LTE/css/AdminLTE.min.css')}}">
   
    <link rel="stylesheet" href="{{asset('LTE/css/bootstrap-select.min.css')}}">



    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="{{asset('LTE/css/_all-skins.min.css')}}">
  ...
  <body class="hold-transition skin-red sidebar-mini">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <li><a href="{{url('/ingreso')}}"><i class="fa fa-circle-o"></i> Ingreso</a></li>
              <li><a href="{{url('/detalle')}}"><i class="fa fa-circle-o"></i> Detalle Reserva</a></li>
    ...
    <!-- jQuery 2.1.4 -->
    <script src="{{asset('LTE/js/jQuery-2.1.4.min.js')}}"></script>
    @stack('scripts')
    <!-- Bootstrap 3.3.5 -->
    <script src="{{asset('LTE/js/bootstrap.min.js')}}"></script>
    <!-- AdminLTE App -->
    <script src="{{asset('LTE/js/app.min.js')}}"></script>
    <script src="{{asset('LTE/js/bootstrap-select.min.js')}}"></script>
